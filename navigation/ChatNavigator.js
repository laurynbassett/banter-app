...
import { ChatListHeaderRight, SingleChatHeaderLeft, SingleChatHeaderCenter } from '../components';

const Stack = createStackNavigator();

export default function ChatNavigator({ navigation, route }) {
	return (
		<Stack.Navigator initialRouteName='Chat' navigationOptions={{ tabBarVisible: false }}>
			<Stack.Screen
				name='Chat'
